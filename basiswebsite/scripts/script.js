...
function imageNaarPizza2() {
    ...
    document.getElementById("sterren").src = "../images/2 sterren.png"; 
} 
...
function imageNaarPizza3() {
    ...
    document.getElementById("sterren").src = "../images/5 sterren.png"; 
} 
...
function imageNaarPizza5() {
    ...
    document.getElementById("sterren").src = "../images/1 ster.png"; 
} 
